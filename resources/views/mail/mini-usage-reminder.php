...
<head>
    ...
    <title>Mini Report Usage Running Low Notification</title>
        ...
        <tr>
            ...
            <td class="container" style="font-family: Helvetica, sans-serif; font-size: 16px; vertical-align: top; max-width: 600px; padding: 0; padding-top: 24px; width: 600px; margin: 0 auto;" width="600" valign="top">
                <div class="content" style="box-sizing: border-box; display: block; margin: 0 auto; max-width: 600px; padding: 0;">
                    ...
                    <span class="preheader" style="color: transparent; display: none; height: 0; max-height: 0; max-width: 0; opacity: 0; overflow: hidden; mso-hide: all; visibility: hidden; width: 0;">Your mini report usage is almost fully used — consider recharging soon.</span>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td align="left" style="font-family: Helvetica, sans-serif; font-size: 16px; vertical-align: top; padding-bottom: 5px;" valign="top">
                                                ...
                                                The mini report usage under your code <?=$coupon->coupon_code?> is almost fully used. To avoid interruption, please recharge before it runs out.
                                                </p>
                                                <p style="font-family: Helvetica, sans-serif; font-size: 16px; font-weight: normal; margin: 0; margin-bottom: 0;">
                                                    <strong>Current Mini Usage Summary:</strong>
                                                </p>
                                                <ul style="font-family: Helvetica, sans-serif; font-size: 16px; font-weight: normal; margin: 0; margin-bottom: 16px;">
                                                    <li><strong>Mini Usage Limit:</strong> <?=$coupon->mini_usage_limit?></li>
                                                    <li><strong>Used:</strong> <?=$coupon->mini_usage_views?></li>
                                                    <li><strong>Remaining:</strong> <?=( $coupon->mini_usage_limit - $coupon->mini_usage_views) ?></li>
                                                </ul>
                                            </td>
                                        </tr>
                                    </tbody>
